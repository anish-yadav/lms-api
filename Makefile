...
build-win :
	...
	@echo "\033[0;31m @GOOS=windows GOARCH=amd64 go build -o ${BIN_DIR}/${SERVER_OUTPUT} cmd/lms/main.go"
	@GOOS=windows GOARCH=amd64 go build -o ${BIN_DIR}/${SERVER_OUTPUT} cmd/lms/main.go
